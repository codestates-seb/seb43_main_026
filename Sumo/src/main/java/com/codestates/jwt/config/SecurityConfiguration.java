...
public class SecurityConfiguration{
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","http://43.200.94.136:8080","http://ec2-43-200-94-136.ap-northeast-2.compute.amazonaws.com:8080"));
